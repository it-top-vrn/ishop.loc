        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col text-end icons">
                    ...
                    <div class="dropdown d-inline-block">
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="<?=PATH?>/public/assets/img/ru.png" alt="">
                        </a>
                        <ul class="dropdown-menu" id="languages">
                            <li>
                                <button class="dropdown-item" data-langcode="en">
                                    <img src="<?=PATH?>/public/assets/img/en.png" alt="">
                                    English</button>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    <a class="navbar-brand" href="<?=PATH?>"><?= App::$app->getProperty('site_name') ?></a>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <?php foreach ($category['children'] as $children) : ?>
                                                    <li><a class="dropdown-item" href="product/<?=$children['slug']?>"><?=$children['title']?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </li>
                                    <?php endif; ?>
